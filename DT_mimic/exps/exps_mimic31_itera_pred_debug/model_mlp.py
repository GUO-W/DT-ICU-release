...
class DTmodel(nn.Module): # Transformer our model v1.0
    def __init__(
        ...
        self.conv2 = nn.Conv1d(self.atten_embed_size, self.atten_embed_size, 3, 2, 1)
        self.conv3 = nn.Conv1d(self.atten_embed_size, self.atten_embed_size, 3, 2, 1)
        ...
        self.fc0 = nn.Linear(self.atten_embed_size, self.atten_embed_size)
    ...
    def forward(self, meds, chart, out, proc, date, ing, stat, demo, key_padding_mask):
        ...
        out1 = self.conv0(out1.permute(0,2,1))
        out1 = self.activation(out1)
        out1 = self.conv1(out1).permute(0,2,1)
        ...
        out = self.conv2(out.permute(0,2,1))
