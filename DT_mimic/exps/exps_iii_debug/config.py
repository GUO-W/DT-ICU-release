...
C.log_dir = osp.join(C.out_dir, "log", C.model.type)
C.snapshot_dir = osp.join(C.out_dir, "snapshot", C.model.type)
C.tensorboard_dir = osp.join(C.out_dir, "tensorboard", C.model.type)
