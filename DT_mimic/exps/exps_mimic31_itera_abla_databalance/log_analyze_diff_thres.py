...
if __name__ == '__main__':
    ...
    log_settings = [
        ...
        {'file': 'abla_databalance_none.txt', 'thresholds': [0.5]}, # no balance at all
        {'file': 'abla_databalance_only_label_balance.txt', 'thresholds': [0.5]}, 
        {'file': '../../exps_mimic31_itera_abla_databalance2/log/abla_databalance_only_data_balance.txt', 'thresholds': 'all'}, 
