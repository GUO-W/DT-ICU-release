...
class DTmodel(nn.Module): # Transformer our model v1.0
    def __init__(
        ...
        self.gru = nn.GRU(input_size=self.atten_embed_size, hidden_size=512, num_layers=4, batch_first=True)
        ...
        self.activation = nn.ReLU()
        self.fc1 = nn.Linear(self.atten_embed_size + 512, 1)
        if self.pred:
