...
if __name__ == "__main__":
    analyze_file("data_seqlen_analy/train_seqlen.txt", "data_seqlen_analy/train_seqlen_distribution.png")
    analyze_file("data_seqlen_analy/val_seqlen.txt", "data_seqlen_analy/val_seqlen_distribution.png")
    analyze_file("data_seqlen_analy/test_seqlen.txt", "data_seqlen_analy/test_seqlen_distribution.png")
...
# def main():
#     # File paths
#     train_file = "data_seqlen_analy/train_seqlen.txt"
#     val_file   = "data_seqlen_analy/val_seqlen.txt"
#     test_file  = "data_seqlen_analy/test_seqlen.txt"
...
#     output_image = "data_seqlen_analy/combined_seqlen_distribution.png"
#     plt.savefig(output_image, bbox_inches="tight")
