...
class DTmodel(nn.Module): # Transformer our model v1.0
    def __init__(
        ...
        self.atten_embed_size = latent_size
        self.cross_embed_size = 0
        self.pred_size = 0

        self.input_fc = nn.Linear(3, self.latent_size)
        ...
        self.atten0 = TransformerBlock(self.latent_size)
        ...
        self.cross_attn = CrossAttention(self.latent_size)
    ...
    def forward(self, dynamic, stat, demo, key_padding_mask, viz=False):
        out1 = self.input_fc(dynamic)
